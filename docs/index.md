---
layout: default
title: Tiation Legal Case Studies - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Legal Case Studies</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-legal-case-studies" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-legal-case-studies .

# Run container
docker run -p 8080:8080 tiation-legal-case-studies
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-legal-case-studies)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-legal-case-studies/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-legal-case-studies/discussions)
